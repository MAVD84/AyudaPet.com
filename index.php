...
function view_detalle(array $mascota, bool $isOwner, array $share, ?string $mapUrl): void {
  ...
  <section class="detail-wrap">
    ...
    <article class="detail-info">
      <?php if ($isOwner): ?><div class="detail-owner-actions"><a class="btn ghost" href="/mascotas/<?= e($mascota['id']) ?>/editar">Editar</a><form method="post" action="/mascotas/<?= e($mascota['id']) ?>/eliminar" onsubmit="return confirm('Eliminar este reporte?');"><button class="btn ghost" type="submit">Eliminar</button></form></div><?php endif; ?>
