...
PAYPAL_SECRET=
PAYPAL_MODE=live
PAYPAL_DONATE_HOSTED_BUTTON_ID=
PAYPAL_DONATE_URL=
...
- Para donativos por PayPal, crea un boton de donacion en PayPal y pon su ID en `PAYPAL_DONATE_HOSTED_BUTTON_ID`. Tambien puedes pegar el enlace completo en `PAYPAL_DONATE_URL`.
